...
class GSE131811Module(pl.LightningDataModule):
    ...
    def extract_constraint_mats(self):
        ...
        # file_inter = glob.glob('../Datasets/Drosophila/' + 'GSM3820057_' + 'cell' + str(self.cellNo) + r'*.mcool')
        file_inter = '../Datasets/Drosophila/GSM3820057_Cell'+str(self.cellNo)+'.10000.mcool'
        ...
        def __init__(self, full, tvt, res, piece_size, percent, dir):
            ...
            if full == True:
                ...
                if tvt == "train":
                    ...
                    self.chros = [2, 6] # original only 6 as the test chromosome
                    # self.chros = [6]
...
if __name__ == '__main__':
    obj = GSE131811Module(percent = 0.75, cell_No = 21)
    obj.prepare_data()
    obj.setup(stage = 'fit')
